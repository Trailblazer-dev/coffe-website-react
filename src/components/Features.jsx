...
const Features = () => {
  return <section className="bg-sponsorbg py-4 font-PopFam" id="features">
    ...
    <div className="grid place-items-center justify-center gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-4">
      {featuresCard.map((card,index)=>(
        <div className="bg-aboutbg w-11/12 h-full py-4 px-8 flex flex-col justify-center items-center rounded-lg shadow-stone-600 shadow-xl" key={index}>

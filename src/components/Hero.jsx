...
const Hero = () => {
  return (
    <>
      <div className=" top-[4rem] sm:top-[5rem] relative h-[50vh] md:h-[60vh] lg:h-[70vh]  pt-28 md:pt-32 lg:pt-44 bg-[#2F1F14] bg-herobg bg-no-repeat bg-cover sm:bg-center place-items-center " id="hero">
